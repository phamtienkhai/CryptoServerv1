...
public class DesProgramUtils {
	...
	public static void main(String[] args) {
		...
		String textFile = "D:\\CryptographyServices\\file test\\secretkey\\docs\\plaintext.txt";
		// path of the encrypted file that we get as output
		String encryptedData = "D:\\CryptographyServices\\file test\\secretkey\\docs\\ciphertext.txt";
		// path of the decrypted file that we get as output
		String decryptedData = "D:\\CryptographyServices\\file test\\secretkey\\docs\\output.txt";
		try {
