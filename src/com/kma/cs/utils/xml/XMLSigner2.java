...
public class XMLSigner2 {
	...
	protected static final String SIGNATURE_METHOD_RSA_SHA256 = "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256";
	protected static final String SIGNATURE_METHOD_RSA_SHA384 = "http://www.w3.org/2001/04/xmldsig-more#rsa-sha384";
	protected static final String SIGNATURE_METHOD_RSA_SHA512 = "http://www.w3.org/2001/04/xmldsig-more#rsa-sha512";
	protected static final String SIGNATURE_METHOD_ECDSA_SHA1 = "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha1";
	protected static final String SIGNATURE_METHOD_ECDSA_SHA256 = "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha256";
	protected static final String SIGNATURE_METHOD_ECDSA_SHA384 = "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha384";
	protected static final String SIGNATURE_METHOD_ECDSA_SHA512 = "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha512";
	protected static final String SIGNATURE_METHOD_DSA_SHA256 = "http://www.w3.org/2009/xmldsig11#dsa-sha256";

	protected String signatureAlgorithm;
	protected String digestAlgorithmString;
	protected String digestMethod;

	public byte[] processData(byte[] dataToSign, CryptoToken cryptoToken, String signatureAlgorithm) {
...
//        KeyStore keyStore = KeyStoreUtils.getKeyStore(aliase, "123456", "D:\\khaipt.p12");
		try {
			...
			Certificate[] certificates = cryptoToken.getCertChain();
			List<Certificate> certificatesList = new ArrayList<Certificate>();
			for (Certificate certificate : certificates) {
				certificatesList.add(certificate);
			}
            byte[] dataSigned = sign(dataToSign, certificatesList, privateKey, "BC");
//			XPathService service = new XPathService();
//			byte[] dataSigned = service.sign(dataToSign, certificatesList, privateKey, providerName, properties,
//					digestAlgorithmString, signatureAlgorithm);
...
//            return dataSignedBase64;
	...
	public byte[] sign(byte[] dataToSign, List<Certificate> certs, PrivateKey privateKey, String providerName) {
		...
		try {
			...
			SignedInfo si = null;
			try {
				final String sigAlg = signatureAlgorithm == null ? getDefaultSignatureAlgorithm(privKey)
						: signatureAlgorithm;
				...
				Reference ref = factory.newReference("", factory.newDigestMethod(digestMethod, null),
						Collections.singletonList(factory.newTransform(Transform.ENVELOPED, (XMLStructure) null)), null,
						null);

//                System.out.println("sigAlg:"+getSignatureMethod(sigAlg));
				si = factory.newSignedInfo(
						factory.newCanonicalizationMethod(CanonicalizationMethod.INCLUSIVE_WITH_COMMENTS,
								(XMLStructure) null),
						factory.newSignatureMethod(getSignatureMethod(sigAlg), null), Collections.singletonList(ref));
...
//            System.out.println(new String(dataSigned));
	...
	protected static String getSignatureMethod(final String sigAlg) throws NoSuchAlgorithmException {
		String result;
...
//		signer.processData("tupk_rsa", "ApacheXMLSig", "<xml>hello world</xml>".getBytes(), "SHA256withRSA", "SHA256",
//				null);
	}
}
